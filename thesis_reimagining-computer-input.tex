...
\emph{Mental impedance} or \emph{Cognitive Load} is an abstract concept covering all the complex ways using an interface can take up more or less of your mental capacity, including; concentration, switching/learning costs, mental \hyperref[org99cfbfd]{congestion}, \hyperref[noise]{noise}, sensory attenuation, etc.
...
Notice that our concept of accesibility has been derived from the information theory primitive of \emph{\hyperref[org1125b77]{system uptime}}.
\subsection{Cost}
\label{sec:org52afe96}
...
Note, \hyperref[org2644eb5]{5AA} \hyperref[mental impedance]{mental impedance} is high as humans do not naturally think and communicate in punched holes.
...
In \hyperref[org2644eb5]{5AA} terms, \hyperref[latency]{latency}, \hyperref[mental impedance]{mental impedance} and \hyperref[abstraction]{abstraction} are all so poor, that operation involves a second human.
...
The keyboard computing revolution was principally a revolution in \hyperref[org2644eb5]{5AA} 1) latency, 2) abstraction, 3) throughput and 4) mental impedance.

By the time electronic input for typewriter keyboards became viable, the typewriter was already over 200 years old and in large-scale use (\hyperref[org2644eb5]{5AA}-familiar).
...
The personal computing revolution was principally a revolution in \hyperref[org2644eb5]{5AA} 1) accessibility, both a) cost, and b) pervasiveness.
...
The GUI revolution was principally a revolution in \hyperref[org2644eb5]{5AA} 1) abstraction, particularly a) familiarity, and related, 2) mental impedance.
...
\section{\hyperref[org39cbd51]{XR} computing}
\label{sec:org33e9f1b}
\begin{mdframed}
\begin{description}
\item[{\label{org39cbd51}XR (Extended Reality)}] Computing environments that are almost totally immersive\footnote{aka very high output bandwidth.} (VR) and/or pervasive (AR); tending to provide an overlay/alternative to 3D-spatial and sensory reality.
\end{description}
\end{mdframed}

At the time of writing we are at the onset of \emph{\hyperref[org39cbd51]{XR} computing revolution} (alt. \emph{\hyperref[wearable computing]{wearable computing}} revolution).
In the \hyperref[org39cbd51]{XR} revolution computers become i) \emph{totally immersive}-- capable of engaging the entire field of perception, and ii) \emph{almost fully pervasive}-- available for use in almost any situation.
In \hyperref[org2644eb5]{5AA} terms, this 1) overhauls throughput-- massively increasing bandwidth, whilst decreasing noise, 2) pushes pervasiveness near its limit-- becoming constantly 'wearable', and (3) considerably reduces impedance, both physical, and mental.
\textbf{We predict that \hyperref[org39cbd51]{XR} will combine the best qualities of desktop and mobile in a single interface and replace them both.}

Note, our focus is on \hyperref[org39cbd51]{XR} as a \hyperref[org6ef4753]{GPC} platform for maximally augmenting human intelligence.
This puts some distance between us and the in-vogue (narrower) outlook of \hyperref[org39cbd51]{XR} as a social-interactive entertainment metaverse of 3D virtual objects\footnote{We call this the 'Zuckervision'.}.
...
This unlocks many aspects of \hyperref[sec:org9801c9a]{Spatial computing} (\S \ref{sec:org9801c9a}) allowing computing configurations such as \emph{strolling desks}.

\section{Spatial computing}
\label{sec:org9801c9a}
\medskip
\begin{mdframed}
\begin{description}
...
Finally there is the more abstract issue of problems relating to \hyperref[sec:org7b0cd10]{brain-computer ADC} (\S \ref{sec:org7b0cd10}).
...
\section{Brain-computer \hyperref[org44fccbb]{ADC} (Analog-to-Digital Conversion)}
\label{sec:org7b0cd10}
\medskip
\begin{mdframed}
\begin{description}
\item[{Brain-Computer \label{org44fccbb}ADC (Analog-to-Digitial Conversion)}] That BCI interfaces must bridge the complex analog--digital divide between humans and computers.
\end{description}
\end{mdframed}
...
Evaluating through our \hyperref[org2644eb5]{5AA} framework, we identify significant \emph{physical obstruction}, increased \emph{latency}, and reduced \emph{throughput}, all in our opinion, unnecessarily.
...
\label{sec:orgf250acb}
A list of \emph{aspiring} design goals for a new \hyperref[org0c83164]{HCID}, generated from our research so far.
\smallskip
...
\markboth{Discussion and Conclusions}{Discussion and Conclusions}
...
\label{sec:org4e5a658}
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../../../Images/artsey_keymap_grey.jpg}
\caption{\hyperref[org0c83164]{HCID} v0.3: Backside keymap \autocite{ARTSEYEasyFast}}
\end{figure}

\chapter{Design Decisions and Discussion}
\label{sec:org427ef7d}
The following is a (lengthy) retroactive record and discussion of the design decisions made up until this point (\hyperref[org0c83164]{HCID} v0.3).
